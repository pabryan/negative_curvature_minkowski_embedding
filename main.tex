...
According to \cite[Section 11]{MR3344442} (see also \Cref{lem:xcf_gcf}), the induced metric \(\tilde{g}_t\) on \(\tilde{M}\) evolves by the Cross Curvature Flow introduced in \cite{MR2055396} (see also \Cref{lem:xcf_gcf} below):
\[
\begin{cases}
