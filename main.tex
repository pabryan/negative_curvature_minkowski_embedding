...
and
\begin{align}
u&=\log\det\opEin,\quad
\Ob_{ij}=\sqrt{\det\opEin}V_{ij},\\
...
\begin{align}
(\partial_t-\Box)(\det\opEin)^\eta=(\frac{\eta}{2}|\Dv^{ijk}|_V^2+\frac{\eta}{2}(1-2\eta)|\T^i|^2_V-2\eta\mathrm{H})(\det\opEin)^\eta,
\end{align}
where $\mathrm{H}=\operatorname{Tr}_g\sigma.$ Therefore, we have the identity
\begin{align}
\frac{d}{dt}\int(\det\opEin)^\eta d\mu=\int (\frac{\eta}{2}|\Dv^{ijk}|_V^2+\frac{\eta}{2}(1-2\eta)|\T^i|^2_V+(1-2\eta)\mathrm{H})(\det\opEin)^\eta d\mu.
\end{align}
