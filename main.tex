...
\usepackage[bibstyle=alphabetic,citestyle=alphabetic,backend=bibtex,maxbibnames=99]{biblatex}
...
\DeclareMathOperator{\opGrav}{\mathcal{G}}
\DeclareMathOperator{\Sch}{P}
\DeclareMathOperator{\W}{\mathcal{W}}
\DeclareMathOperator{\Wy}{C}
